package com.mobiledev.SEdu.assessment.model;
...
public class Question {
    ...
    public Question(String topicId, String content, List<String> options, Integer correctOptionIndex, String imageUrl) {
        this.topicId = topicId; this.content = content; this.options = options;
        this.correctOptionIndex = correctOptionIndex; this.imageUrl = imageUrl;
    }
